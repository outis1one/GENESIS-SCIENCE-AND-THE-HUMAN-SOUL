...
content.push(para([
  ...
  magLink("Humani Generis", 'HUMANI_GENERIS'),
  magSectionLink(", paragraph 36", 'HUMANI_GENERIS'), t(").")
]));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("Genesis_Science_Catholic_Theology-35.docx", buffer);

...
content.push(para([
  t("The young earth position rests on several arguments that carry real weight. They deserve a fair hearing.")
]));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("Genesis_Science_Catholic_Theology-32.docx", buffer);

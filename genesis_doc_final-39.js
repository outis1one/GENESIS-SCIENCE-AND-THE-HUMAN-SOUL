...
content.push(heading2("The Church Fathers and the Fourth Lateran Council: Why They Do Not Settle the Question"));

content.push(para([
  t("Chapter 2 presented two of the strongest Catholic arguments for a required young earth: the claim that the Church Fathers unanimously taught a young earth chronology, and the claim that the Fourth Lateran Council dogmatically defined instantaneous creation. Both deserve careful examination.")
]));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("Genesis_Science_Catholic_Theology-39.docx", buffer);

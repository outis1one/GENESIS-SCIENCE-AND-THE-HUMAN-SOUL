...
content.push(new Paragraph({
  alignment: AlignmentType.CENTER,
  spacing: { before: 400 },
  children: [new TextRun({ text: "A Biblical view of Creation, read through the full witness of Scripture,", size: 22, italics: true, font: "Georgia" })]
}));
content.push(new Paragraph({
  alignment: AlignmentType.CENTER,
  spacing: { before: 60 },
  children: [new TextRun({ text: "the teachings of the Catholic Church, and the evidence of God\u2019s creation itself", size: 22, italics: true, font: "Georgia" })]
}));
content.push(new Paragraph({
  alignment: AlignmentType.CENTER,
  spacing: { before: 2000 },
...
// Manual TOC with internal hyperlinks - these bookmark IDs match what heading1() generates
const tocEntries = [
...
content.push(para([
  t("A word about what this document is and is not. "),
  ti("This is a Biblical view of creation."),
...
content.push(para([
  ...
  cite('FIDES'),
  t(" The encyclical warns against two opposite errors. The first is fideism\u2014the position that faith alone is sufficient and that reason is irrelevant or dangerous to belief. The Church rejects this: a faith that fears honest inquiry is a faith that doubts its own foundations. The second is rationalism or scientism\u2014the position that empirical science is the only valid path to knowledge, and that anything science cannot measure does not exist. The Church rejects this too: a reason that refuses to ask questions beyond its own methods is a reason that has arbitrarily narrowed the scope of truth. This document is written in the conviction that faith needs reason and reason needs faith. The believer who dismisses the fossil record has not defended the faith; he has abandoned the Catholic intellectual tradition that produced Albertus Magnus, Gregor Mendel, and Georges Lema\u00EEtre. The scientist who dismisses the possibility of an immaterial soul has not followed the evidence; she has adopted a philosophical assumption that her own methods cannot justify. If this document succeeds, it will be because it takes both wings seriously.")
]));
...
content.push(para([
  ...
  ti("Firmiter"),
  t(" constitution, dogmatically defined fiat creation."),
  cite('LATERAN_IV'),
  t(" The key Latin text reads: "),
...
content.push(para([
  ...
  ti("de fide"),
  t(" (divinely revealed) teachings of the Church."),
  cite('OTT'),
  t(" The Pontifical Biblical Commission (1909) explicitly ruled that the word "),
  ti("yom"),
...
content.push(heading2("The Variable Constants Argument\u2014and Why It Proves Too Much"));

content.push(para([
  t("The most sophisticated version of the young earth scientific case is the argument that physical constants and natural rates were not uniform across time\u2014that the speed of light, radioactive decay rates, and geological processes may have operated at dramatically different rates in the past. This argument deserves careful attention, because it contains a genuine insight wrapped in a fatal problem.")
]));

content.push(para([
  t("The genuine insight is this: science has indeed revised its understanding of constants and frameworks. Copernicus proposed that the earth orbited the sun rather than the reverse (1543). Kepler refined the model by replacing circular orbits with elliptical ones and formulating his three laws of planetary motion (1609\u20131619). Galileo championed the heliocentric model based on his telescopic observations and published his famous "),
  ti("Dialogue Concerning the Two Chief World Systems"),
  t(" in 1632. The Galileo affair deserves an accurate telling, because it is one of the most frequently cited and most frequently distorted episodes in the history of science and religion. Galileo was not excommunicated\u2014a widespread misconception. He was not tortured. He was not imprisoned in a dungeon. What actually happened is more complicated and, in some ways, more instructive. In 1616, Cardinal Bellarmine warned Galileo not to hold or defend heliocentrism as established fact. Pope Urban VIII, who was personally friendly to Galileo and a patron of his work, later gave him permission to write about heliocentrism on the condition that he treat it as a mathematical hypothesis rather than established truth. Galileo\u2019s "),
  ti("Dialogue"),
  t(" went far beyond this agreement: it presented heliocentrism as clearly superior, and it placed arguments resembling the Pope\u2019s own views in the mouth of a character named Simplicio\u2014a name that, in Italian, carries the connotation of \u201Csimpleton.\u201D Urban, already under political pressure from other quarters, felt personally mocked and betrayed. The resulting trial in 1633 was driven by a combination of factors: the scientific question of heliocentrism, Galileo\u2019s apparent violation of the 1616 injunction, and the personal and political fallout of the "),
  ti("Dialogue"),
  t("\u2019s publication. Galileo was convicted of \u201Cvehement suspicion of heresy\u201D\u2014a lesser charge than heresy itself\u2014forced to recant, and placed under house arrest for the remainder of his life. He continued his scientific work under house arrest and published his most important physics text, the "),
  ti("Two New Sciences"),
  t(", in 1638. The Church\u2019s treatment of Galileo was a serious error\u2014one that Pope John Paul II formally acknowledged in 1992 when he declared the condemnation to have been a mistake. The episode is a sobering reminder that institutions, including the Church, can err when they treat scientific questions as matters of theological authority\u2014a lesson that cuts in more than one direction. Einstein replaced Newton\u2019s absolute space and time with relativity, showing that time itself dilates at high velocities and in strong gravitational fields, and that the relationship between energy and matter (E=mc\u00B2) was not what anyone had imagined. These were genuine paradigm shifts that overturned centuries of \u201Csettled science.\u201D The young earth advocate is right to point out that scientific consensus is not infallible.")
]));

content.push(para([
  t("However, two critical observations apply. First, Copernicus and Kepler did not overthrow astronomy\u2014they refined it. The heliocentric model explained the same observational data that Ptolemy\u2019s geocentric model explained, but more simply and with greater predictive power. Einstein did not overthrow Newton\u2014Newtonian mechanics remains accurate at low velocities and weak gravitational fields. Einstein\u2019s framework encompasses Newton\u2019s as a special case. Scientific revolutions do not typically prove the previous framework \u201Cwrong\u201D\u2014they reveal it as a limited approximation of a deeper truth. The observational data that led to the old framework remains valid; only the interpretation deepens.")
]));

content.push(para([
  t("This matters because the young earth variable-constants argument does not propose a refinement or deepening. It proposes that the observational data itself is misleading\u2014that the light arriving from Andromeda, the isotope ratios in zircon crystals, the annual layers in ice cores, and the chalk of the White Cliffs of Dover are all artifacts of processes that operated at rates so different from today that every measurement based on current observations is off by a factor of a million or more. This is not a Copernicus-to-Einstein refinement. It is a wholesale rejection of observational reliability.")
]));

content.push(para([
  t("Second, and more damaging: the specific examples cited by young earth advocates do not actually support variable constants\u2014they illustrate variable conditions, which is a very different thing.")
]));

content.push(para([
  t("Consider stalactites. It is true that mineral deposits can form rapidly on concrete and in mines\u2014sometimes inches per year. But this does not demonstrate that cave stalactites grow faster than measured. It demonstrates that mineral deposition rates depend on water chemistry, flow rate, temperature, and CO\u2082 concentration. Concrete is highly alkalite and calcium-rich; water flowing through it picks up dissolved minerals at rates far exceeding what occurs in natural limestone caves. The stalactites forming on bridge underpasses are chemically different from cave speleothems\u2014they are soft calcium hydroxide deposits, not the hard calcite of natural caves. Comparing the two is like comparing the \u201Cgrowth rate\u201D of icicles to glaciers: they are different processes producing superficially similar shapes. In natural caves, stalactite growth rates have been measured directly using markers, radiometric dating of growth layers, and comparison with known historical events\u2014and they consistently yield rates of 0.1 to 3 millimeters per year in active caves, with some variation based on water flow. The rate is variable\u2014but variable within a range that still produces old caves, not young ones.")
]));

content.push(para([
  t("The White Cliffs of Dover present a similar case. Young earth advocates are correct that coccolithophore blooms can be massive\u2014satellite imagery confirms this. But the chalk of Dover is not raw coccolithophore material. It has undergone what geologists call diagenesis\u2014a slow transformation that occurs when sediment is buried under enormous weight over long periods. The original loose ooze of dead microorganisms was compressed under hundreds of meters of overlying sediment, squeezing out water and compacting the material into the dense, hard chalk we see today. This compaction means that the 110 meters of chalk visible in the cliffs represents an original deposit many times thicker\u2014perhaps 300 to 500 meters of loose sediment, compressed over millions of years into the hard rock that now faces the English Channel. Moreover, the chalk contains fossils of larger marine organisms\u2014ammonites (coiled-shell creatures related to modern nautiluses), sea urchins, and belemnites (squid-like animals)\u2014distributed throughout its depth, representing species that lived, reproduced, and died in succession across the seafloor. These fossils show what biologists call ecological succession: different species at different levels, representing different communities that occupied the sea at different times, just as different layers of a forest floor contain leaves from different seasons. A single catastrophic bloom, no matter how massive, would not produce this stratified fossil succession. It would produce a single homogeneous layer\u2014one thick blanket of the same material, not a layer cake of different communities.")
]));

content.push(para([
  t("The c-decay hypothesis\u2014the proposal that the speed of light was dramatically faster in the past\u2014faces the most severe difficulties of all. Barry Setterfield\u2019s original 1987 paper proposing declining light speed was based on historical measurements of the speed of light that appeared to show a decrease over time. Subsequent analysis demonstrated that the apparent decrease was an artifact of improving measurement precision: earlier, less accurate instruments had larger margins of error that happened to skew high, and when the data is properly adjusted for each instrument\u2019s known accuracy, no decline is detectable. More fundamentally, the speed of light is not an isolated number that can be changed independently. It is woven into the deepest structure of physics\u2014it appears in Maxwell\u2019s equations (the mathematical laws governing electricity and magnetism), in quantum electrodynamics (the theory describing how light and matter interact at the subatomic level), and in the fine-structure constant (a number, approximately 1/137, that determines the strength of the electromagnetic force\u2014how strongly electrons are held in their orbits around atoms). If you change the speed of light, all of these change together. Changing it by the factors required\u2014millions-fold\u2014would alter the strength of the electromagnetic force, the energy levels of atoms, the rates of all chemical reactions, and the very structure of matter itself. Stars could not burn, because nuclear fusion depends on precise relationships between these constants. Atoms could not hold together in their current configurations. Chemistry as we know it\u2014including the chemistry of life\u2014would be impossible. A universe with a speed of light millions of times higher than today\u2019s would not look like our universe running on a faster clock. It would be a fundamentally different universe, unrecognizable and uninhabitable.")
]));

content.push(para([
  t("The same problem afflicts accelerated radioactive decay. The RATE project themselves acknowledged this: if billions of years\u2019 worth of radioactive decay occurred in a few thousand years, the thermal energy released would have melted the earth\u2019s crust multiple times over. They candidly described this as requiring unknown \u201Cmiracles\u201D to resolve\u2014divine interventions to dissipate the heat without destroying the planet. At this point, the argument has moved from science to theology: the physical constants were different, and God miraculously prevented the catastrophic consequences of their being different. This may be possible for an omnipotent God, but it returns us directly to the Omphalos problem\u2014a God who arranges the physical evidence to tell a story that did not happen.")
]));

content.push(para([
  tb("A note on paradigm shifts and historical corrections. "),
  t("Young earth advocates are right that science has undergone revolutions. But it is important to get the history right. The popular claim that Christopher Columbus proved the earth was round against the belief of his contemporaries is, unfortunately, a myth. Educated Europeans in the fifteenth century knew the earth was spherical\u2014this had been established by the ancient Greeks (Eratosthenes calculated the earth\u2019s circumference with remarkable accuracy around 240 BC) and was standard teaching in medieval universities. Columbus\u2019s critics did not think he would sail off the edge of a flat earth; they thought (correctly) that he had underestimated the earth\u2019s circumference and would run out of supplies before reaching Asia. He survived only because an entire continent he did not know existed happened to be in the way. The flat-earth myth was popularized by Washington Irving\u2019s 1828 fictionalized biography of Columbus and has persisted ever since.")
]));
...
content.push(para([
  t("The Catholic position, expressed by the International Theological Commission in 2004, is clear: \u201CVirtually all, if not all, parsimony arguments based on molecular biology and genomics suggest a common ancestry of living organisms.\u201D"),
  cite('ITC_2004'),
  t(" The Church does not require Catholics to accept or reject evolution in its biological details. But it does require intellectual honesty about what the evidence shows\u2014and the evidence for common descent and deep time is not a house of cards waiting for one constant to be revised. It is a convergence of independent lines of evidence, each using different physical processes, each cross-checked against the others.")
]));
...
content.push(para([
  t("The starlight problem is the most vivid illustration of the difficulty with the appearance-of-age argument\u2014but it is also, when taken seriously, one of the most beautiful arguments for the grandeur of God\u2019s creative plan.")
]));
...
content.push(para([
  t("To answer this question with precision, we must understand the levels of doctrinal authority in Catholic theology. Ludwig Ott, in the seminary reference work discussed earlier, "),
  ti("Fundamentals of Catholic Dogma"),
  t(" (1952),"),
  cite('OTT'),
...
content.push(para([
  ...
  ti("yom"),
  t(" (day) be taken either in the literal sense for the natural day or in an applied sense for a certain space of time, and may this question be the subject of free discussion among exegetes?\u201D The Commission answered: \u201CIn the affirmative.\u201D"),
  cite('PBC_1909'),
  t(" The same Commission affirmed (Question VII) that the sacred author did not intend \u201Cto give scientific teaching about the internal constitution of visible things\u201D but rather \u201Ca popular notion in accord with the current speech of the time.\u201D And (Question VI) that \u201Cprovided that the literal and historical sense is presupposed,\u201D passages \u201Cmay wisely and profitably be interpreted in an allegorical and prophetical sense, in the light of the example of the holy Fathers and of the Church itself.\u201D")
]));
...
content.push(para([
  t("Kemp\u2019s model is elegant and has been widely discussed. It preserves strict monogenism\u2014the theological doctrine that all true humans descend from a single original pair\u2014while accepting the genetic evidence for a larger ancestral population. The International Theological Commission\u2019s 2004 language about human emergence \u201Cwhether as individuals or in populations\u201D seems to leave room for exactly this kind of model.")
]));
...
content.push(para([
  t("The weakness is genetic. Population geneticists argue that the allelic diversity patterns in the human genome\u2014that is, the number of different versions of each gene that exist across the human population (each version is called an \u201Callele,\u201D and a single pair of parents can pass on at most four alleles for any given gene)\u2014particularly in the HLA immune system genes (a family of genes that help the body recognize and fight diseases, and which are among the most genetically diverse genes in the human genome, with some variants so old they predate the split between humans and chimpanzees)\u2014cannot be explained by descent from two individuals at any point in "),
  ti("Homo sapiens"),
...
content.push(para([
  t("When these massive stars exhaust their fuel, they collapse and explode as supernovae. The explosion generates temperatures and pressures extreme enough to forge some elements heavier than iron through what physicists call the rapid neutron-capture process, or r-process\u2014essentially, atomic nuclei are bombarded with neutrons so fast that they absorb many before they can decay, building up to heavier and heavier elements in fractions of a second. The explosion scatters these newly created elements into the surrounding space\u2014the vast, thin clouds of gas and dust between the stars, called the interstellar medium\u2014enriching it with the raw materials for a second generation of stars and, crucially, for rocky planets. However, supernovae are not the only source of heavy elements. In 2017, the LIGO and Virgo gravitational-wave detectors observed the merger of two neutron stars (event GW170817), and the electromagnetic afterglow\u2014called a kilonova\u2014confirmed that neutron star mergers are a major, perhaps dominant, source of the heaviest r-process elements: gold, platinum, and uranium among them."),
  cite('PIAN'),
  t(" In 2023, the James Webb Space Telescope spectroscopically identified tellurium in a kilonova, providing the most direct identification yet of a specific heavy element produced in a neutron star merger."),
  cite('LEVAN'),
...
content.push(para([
  t("For the next two billion years\u2014a span almost incomprehensibly long\u2014life consists entirely of single-celled organisms. Bacteria and archaea (an ancient group of single-celled organisms that look superficially like bacteria under a microscope but are genetically as different from bacteria as you are) dominate. They transform the planet\u2019s chemistry: cyanobacteria develop photosynthesis, producing oxygen as a waste product, gradually converting Earth\u2019s atmosphere from one with almost no free oxygen to one rich in it. This is the Great Oxidation Event, roughly 2.4 billion years ago. It is simultaneously one of the greatest ecological catastrophes in Earth\u2019s history (organisms that had evolved in an oxygen-free world\u2014called anaerobic organisms\u2014were poisoned by this new, chemically aggressive gas) and the essential precondition for all complex life to come.")
]));

content.push(heading3("Stage Five: Complex Life and the Cambrian Explosion (1 Billion to 500 Million Years Ago)"));

content.push(para([
  t("Approximately 1.5 to 2 billion years ago, eukaryotic cells appear\u2014cells with a true nucleus (a membrane-enclosed compartment containing the cell\u2019s DNA), mitochondria (tiny internal power plants that generate energy for the cell, believed to have once been free-living bacteria that were engulfed by and became permanently incorporated into larger cells), and internal organization far more complex than bacteria. Around 600 million years ago, multicellular organisms emerge. Then, approximately 540 million years ago, the Cambrian explosion occurs: in a geologically brief window of perhaps 20 million years, nearly all major animal body plans appear in the fossil record. This event has fascinated and troubled biologists since Darwin, who acknowledged it as a difficulty for his theory. The Augros/Stanciu thesis offers an interpretation: the Cambrian explosion represents the activation of latent developmental potential that had been building in the genome for hundreds of millions of years, triggered by the right environmental and genetic conditions.")
]));
...
content.push(para([
  t("However\u2014and this is important\u2014the gap between the Augros/Stanciu proposal and mainstream science has narrowed dramatically since 1987, and the narrowing has come primarily from the science side. Three major discoveries have moved mainstream biology significantly toward the kind of \u201Clatent potential\u201D model Augros and Stanciu proposed.")
]));

content.push(para([
  tb("First: the Hox gene revolution. "),
  t("In 1978, Edward B. Lewis discovered what are now called Hox genes\u2014a small set of \u201Cmaster switch\u201D genes that control the basic body plan of an organism: where the head goes, where the limbs go, how many segments the body has, and so on. The stunning surprise was that these master genes are virtually identical across vastly different animals. The same Pax-6 gene that builds eyes in fruit flies also builds eyes in mice, squid, and humans\u2014despite these eyes being dramatically different in structure. The same distal-less gene that builds legs in insects also builds fins in fish, wings in chickens, and tube feet in sea urchins. These genes are ancient, dating back at least 635 million years to the last common ancestor of all animals with bilateral symmetry (animals whose left and right sides mirror each other\u2014which includes everything from worms to whales). What this means is that the genetic \u201Ctoolkit\u201D for building animal body plans has been present in the genome for hundreds of millions of years, largely unchanged. New body plans arise not by inventing new genes but by changing when, where, and how long these existing toolkit genes are switched on during embryonic development. A small change in the timing or location of a single regulatory gene\u2019s expression can produce a dramatically different body form. This is remarkably close to what Augros and Stanciu proposed: that organisms carry latent developmental potential that is \u201Cswitched on\u201D under the right conditions.")
]));

content.push(para([
  tb("Second: the \u201Cjunk DNA\u201D revolution. "),
  t("When the Human Genome Project was completed in 2003, scientists discovered that only about 1\u20132% of human DNA actually codes for proteins\u2014the molecular machines that do the cell\u2019s work. The remaining 98\u201399% was widely dismissed as \u201Cjunk DNA\u201D: evolutionary leftovers, broken genes, viral debris, and meaningless repetition. This dismissal has turned out to be spectacularly premature. The ENCODE project (Encyclopedia of DNA Elements), a massive international research effort launched in 2003 and reporting major results in 2012, found that at least 80% of the human genome shows signs of biochemical activity."),
  cite('ENCODE'),
  t(" Much of the so-called junk turns out to be regulatory DNA\u2014sequences that control when and where the protein-coding genes are turned on and off. There are enhancers (which increase a gene\u2019s activity), silencers (which decrease it), insulators (which prevent one gene\u2019s regulation from bleeding over into a neighbor), and vast networks of non-coding RNA molecules that participate in gene regulation in ways still being mapped. The exact percentage that is truly \u201Cfunctional\u201D in the strictest evolutionary sense is still debated\u2014some scientists argue 80% is an overestimate and that a more conservative figure is 9\u201315%\u2014but no serious biologist now claims that non-coding DNA is simply junk. The discovery of this enormous regulatory layer is directly relevant to the Augros/Stanciu thesis: it means the genome contains vast amounts of DNA that is not currently building anything but that \u201Cknows how to\u201D\u2014that can be activated under the right conditions to produce new regulatory patterns and potentially new body forms.")
]));

content.push(para([
  tb("Third: the evo-devo revolution. "),
  t("Evolutionary developmental biology\u2014\u201Cevo-devo\u201D for short\u2014has emerged since the late 1990s as one of the most productive areas of biological research. Its central finding is that evolution works primarily by modifying the regulatory networks that control development, not by creating new structural genes. A chicken and a snake share most of the same genes. The difference between them lies largely in how those genes are regulated during embryonic development\u2014which ones are turned on, in what sequence, for how long, and in which part of the embryo. The Cambrian explosion\u2014that geologically sudden appearance of nearly all major animal body plans roughly 540 million years ago\u2014is increasingly understood as the result of regulatory gene networks reaching a critical level of complexity, enabling a burst of new body forms from an existing genetic toolkit. Sean B. Carroll, one of the leading figures in evo-devo, has argued that had these insights been available earlier, embryology would have been central to the original Modern Synthesis of evolutionary theory in the 1930s."),
  cite('CARROLL_EVO')
]));

content.push(para([
  t("To be clear: mainstream evo-devo does not endorse the full Augros/Stanciu thesis. The mainstream view is that regulatory changes are driven by the same Darwinian mechanisms\u2014random mutation and natural selection\u2014that drive all evolution. Augros and Stanciu proposed something stronger: that the latent potential is itself designed, that the unfolding is directed rather than random. This is a philosophical and theological claim, not a strictly scientific one, and it goes beyond what the data alone can prove. But the scientific foundation they built on\u2014that organisms carry unexpressed genetic potential that can produce new body forms through changes in gene regulation rather than through the creation of new genes\u2014has turned out to be far more prescient than their critics in 1987 expected. They were right that the genome is not a static blueprint but a dynamic, layered system with enormous latent capacity. They were right that \u201Cjunk DNA\u201D was not junk. And they were right that changes in gene regulation, not just random point mutations, are the primary engine of evolutionary innovation in body plans. Whether that regulatory capacity was designed or is simply the product of deep evolutionary time is a question that science alone cannot answer\u2014and that is precisely where theology enters the picture.")
]));
...
content.push(para([
  ...
  ti("Homo sapiens"),
  t(", there are too few Denisovan fossils to give a complete physical description of the species. Until June 2025, when the Harbin cranium was identified as potentially Denisovan through mitochondrial DNA (DNA inherited only from the mother, found in the cell\u2019s energy-producing structures, which degrades more slowly than regular DNA and can sometimes survive in ancient bones for hundreds of thousands of years) and protein analysis of bone tissue, they had not even been given a formal species name\u2014they are the first ancient hominid species identified primarily through DNA rather than fossils.")
]));

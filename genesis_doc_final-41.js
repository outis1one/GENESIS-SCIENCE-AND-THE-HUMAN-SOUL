...
content.push(para([
  tb("The Cana Wine Analogy. "),
  t("The Kolbe Center draws a parallel to Jesus turning water into wine at Cana: the wine had the chemical markers of fermentation and aging, yet was created instantly. Therefore, they argue, we can only know the true age of creation from Scripture, not from scientific analysis. The analogy is vivid but breaks down at a critical point. The wedding guests at Cana were not deceived: they were presented with wine, and it was wine. No one examined it scientifically and drew false conclusions about its age. The wine did not "),
  ti("testify"),
  t(" to a history of grape cultivation, fermentation, and barrel aging that never occurred. By contrast, the Omphalos hypothesis requires that creation testifies elaborately and consistently to billions of years of events that never happened\u2014events recorded in ice cores, tree rings, fossils, radioactive isotopes, stellar spectra, and the cosmic microwave background. The Cana wine had no false "),
  ti("history"),
  t(" embedded in it. The Omphalos cosmos does. Furthermore, the Cana miracle is attested by divine revelation (Scripture). The supposed youth of the cosmos is not\u2014no council, encyclical, or ex cathedra statement defines the earth\u2019s age. We know the wine was created miraculously because God told us so. No equivalent revelation tells us the ice cores are lying.")
]));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("Genesis_Science_Catholic_Theology-41.docx", buffer);
